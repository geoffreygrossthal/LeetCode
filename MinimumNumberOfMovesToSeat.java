...
//Program: Leetcode problem Minimum Number of Moves to Seat Everyone
...
public class MinimumNumberOfMovesToSeat {
    ...
    //Method returns the minimum number of moves to seat all the students
    public int minMovesToSeat(int[] seats, int[] students) {
        ...
        for (int i = 0; i < students.length; ++i)
            total_moves += Math.abs(seats[i] - students[i]);
