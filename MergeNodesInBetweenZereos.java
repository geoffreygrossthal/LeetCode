...
//Program: Leetcode problem Merge Nodes in Between Zereos
...
public class MergeNodesInBetweenZereos {

    //Method returns new list with nodes between 0s merged
    public ListNode mergeNodes(ListNode head) {
        ...
        //Can start past the starting zero
        head = head.next;

        while (head != null) {
            //Encountered second zero
            if (head.val == 0) {
